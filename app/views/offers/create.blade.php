...
{{ Form::open(array('url' => 'offers', 'files' => true)) }}
<header>
...
<fieldset>
    ...
    <section>
        ...
        <div class="col col-6">
            ...
            <label class="select">
            {{ Form::select('network', array('0' => 'OB Media', '1' => 'Adknowledge', '2' => 'Adconion', '3' => 'Riip')) }}
               <i></i> </label>
    ...
    <section>
        <div class="col col-6">
            ...
            <label class="textarea">
                {{ Form::textarea('subjectLines', null, array('class' => 'custom-scroll', 'rows' => '10')) }}
            </label>
            <div class="note">
        ...
        <div class="col col-6">
            ...
            <label class="textarea">
                {{ Form::textarea('friendlyFromLines', null, array('class' => 'custom-scroll', 'rows' => '6')) }}
            </label>
        </div>
